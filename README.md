...
## 프로젝트 개요
**팀명:** 뉴노멀리스트 | **프로젝트명:** MSA 기반 뉴스 수집 및 검색 플랫폼 서비스 | **사이트명:**  NewSpare | **진행 기간:** 2025.07.18 ~ 2025.09.10

뉴스 수집 및 검색 플랫폼의 주요 서비스(회원기능, 뉴스 크롤링, 툴팁, 개인화 추천, 뉴스레터, 스크랩, 뉴스 요약 등)를 MSA 아키텍처 기반으로 구현하고, 이후 CI/CD 및 클라우드 배포 환경까지 실제 서비스 운영 경험을 목표로 한 뉴스 플랫폼 프로젝트
...
| ------ | ---------------------------------- | -------------------------------------------------------------- |
| 김지환 | **AI 요약/프롬프트튜닝/산출물관리/**           | Flask API 및 AI 요약, 산출물 관리, 프롬프트 엔지니어링              |
